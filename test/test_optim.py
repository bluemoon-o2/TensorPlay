import sys
import os
sys.path.append(os.path.join(os.path.dirname(__file__), '../tensorplay'))
# Also add the parent of tensorplay package if needed, but usually we want to import tensorplay package
# If D:\pytorch-2.8.0\tensorplay is the root, and it contains tensorplay package.
sys.path.append(r'd:\pytorch-2.8.0\tensorplay')
