...
TENSORPLAY_REGISTER_KERNEL_STR("transpose", CPU, transpose_kernel)
...
TENSORPLAY_REGISTER_KERNEL_STR("t", CPU, t_kernel)
...
TENSORPLAY_REGISTER_KERNEL_STR("permute", CPU, permute_kernel)
...
TENSORPLAY_REGISTER_KERNEL_STR("squeeze", CPU, squeeze_kernel)
...
TENSORPLAY_REGISTER_KERNEL_STR("squeeze.dim", CPU, squeeze_dim_kernel)
...
TENSORPLAY_REGISTER_KERNEL_STR("unsqueeze", CPU, unsqueeze_kernel)
...
TENSORPLAY_REGISTER_KERNEL_STR("cat", CPU, cat_kernel)
...
TENSORPLAY_REGISTER_KERNEL_STR("stack", CPU, stack_kernel)
...
TENSORPLAY_REGISTER_KERNEL_STR("split", CPU, split_kernel)
...
TENSORPLAY_REGISTER_KERNEL_STR("split.sizes", CPU, split_sizes_kernel)
...
TENSORPLAY_REGISTER_KERNEL_STR("chunk", CPU, chunk_kernel)
...
TENSORPLAY_REGISTER_KERNEL_STR("reshape", CPU, reshape_kernel)
...
TENSORPLAY_REGISTER_KERNEL_STR("unbind", CPU, unbind_kernel)
