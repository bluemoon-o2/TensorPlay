...
/* The original source of this file has been modified: the functions carry
   target("avx2,fma") so they can be compiled inside a scalar TU and dispatched
   at runtime (see DistributionsHelper.h). */
