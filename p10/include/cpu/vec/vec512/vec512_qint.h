...
// Quantized 512-bit registers: the qint32/qint8/quint8 converters over one
// 512-bit integer register, with the wider-lane dequantize / quantize /
// requantize entry points and the vbmi gather-based converters.
...
#ifdef _MSC_VER
__declspec(align(64)) struct Vectorizedqi512 {
 protected:
  __m512i vals;
#else
struct Vectorizedqi512 {
 protected:
 ...
 public:
  ...
  Vectorizedqi512(__m512i v) : vals(v) {}
...
inline __m512i pack_saturate_and_clamp<int32_t>(
  ...
  throw std::runtime_error("pack_saturate_and_clamp<int32_t> is not supported");
  return __m512i{};
}
...
typename std::enable_if_t<
    ...
    tensorplay::vec::Vectorized<
        float>> inline convert_int8_to_float(tensorplay::vec::Vectorized<T> src) {
  // Note: this function only convert inputs number of elements equal to
  // tensorplay::vec::Vectorized<float>.size() Only handle first 16*8 bits
...
template <typename T>
tensorplay::vec::Vectorized<T> inline convert_float_to_int8(
    tensorplay::vec::Vectorized<float> src);

template <>
tensorplay::vec::Vectorized<int8_t> inline convert_float_to_int8(
    tensorplay::vec::Vectorized<float> src) {
...
template <>
tensorplay::vec::Vectorized<uint8_t> inline convert_float_to_int8(
    tensorplay::vec::Vectorized<float> src) {
...
template <typename T>
tensorplay::vec::Vectorized<T> inline round_convert_float_to_int8(
    tensorplay::vec::Vectorized<float> src);

template <>
tensorplay::vec::Vectorized<int8_t> inline round_convert_float_to_int8(
    tensorplay::vec::Vectorized<float> src) {
...
template <>
tensorplay::vec::Vectorized<uint8_t> inline round_convert_float_to_int8(
    tensorplay::vec::Vectorized<float> src) {
...
__FORCE_INLINE void QuantizeAvx512(
  ...
  // Saturating pack + clamp over four int32 registers.
...
template <>
struct is_vec_specialized_for<tensorplay::qint32> : std::bool_constant<true> {};

template <>
struct Vectorized<tensorplay::qint32> : public Vectorizedqi512 {
  using size_type = int;
  ...
  using int_vec_return_type = std::array<Vectorized<tensorplay::qint32>, 1>;
  using value_type = tensorplay::qint32::underlying;

 public:
  using Vectorizedqi512::Vectorizedqi512;
  Vectorized() = default;
  ...
  Vectorized(const tensorplay::qint32& val) {
  ...
  static Vectorized<tensorplay::qint32> loadu(const void* ptr) {
    return Vectorized<tensorplay::qint32>(ptr);
  }

  static Vectorized<tensorplay::qint32> loadu(const void* ptr, int64_t count) {
  ...
  static Vectorized<tensorplay::qint32> quantize(
      const float_vec_return_type& rhs,
      float scale,
      int32_t zero_point,
      float inverse_scale [[maybe_unused]]) {
    Vectorized<tensorplay::qint32> retval = {};
    auto rhs_data = (__m512)rhs[0];
    tensorplay::quantize_vec<tensorplay::qint32, /*precision=*/32>(
        scale, zero_point, (float*)&rhs_data, (tensorplay::qint32*)&retval.vals, 16);
    return retval;
  }

  Vectorized<tensorplay::qint32> maximum(Vectorized<tensorplay::qint32> b) const {
    return _mm512_max_epi32(vals, b.vals);
  }

  Vectorized<tensorplay::qint32> minimum(Vectorized<tensorplay::qint32> b) const {
    return _mm512_min_epi32(vals, b.vals);
  }

  Vectorized<tensorplay::qint32> relu(Vectorized<tensorplay::qint32> zero_point) const {
    return maximum(zero_point);
  }

  Vectorized<tensorplay::qint32> relu6(
      Vectorized<tensorplay::qint32> zero_point,
      Vectorized<tensorplay::qint32> q_six) {
    return _mm512_min_epi32(
        _mm512_max_epi32(vals, zero_point.vals), q_six.vals);
  }

  int_vec_return_type widening_subtract(Vectorized<tensorplay::qint32> b) const {
    return {_mm512_sub_epi32(vals, b)};
  }

  static Vectorized<tensorplay::qint32> requantize_from_int(
...
template <>
Vectorized<tensorplay::qint32> inline maximum(
    const Vectorized<tensorplay::qint32>& a,
    const Vectorized<tensorplay::qint32>& b) {
  return a.maximum(b);
}

template <>
Vectorized<tensorplay::qint32> inline operator*(
    const Vectorized<tensorplay::qint32>& a,
    const Vectorized<tensorplay::qint32>& b) {
...
__m512i RequantizeAvx512(
    const std::array<Vectorized<tensorplay::qint32>, 4>& inp,
    __m512 multiplier,
    __m512i zp) {
  static_assert(
...
template <>
struct is_vec_specialized_for<tensorplay::qint8> : std::bool_constant<true> {};

template <>
struct Vectorized<tensorplay::qint8> : public Vectorizedqi512 {
  ...
  using int_vec_return_type = std::array<Vectorized<tensorplay::qint32>, 4>;
  using value_type = tensorplay::qint8::underlying;
 ...
 public:
  ...
  // Broadcast constructor
  Vectorized(const tensorplay::qint8& val) {
    value_type uw = val.val_;
  ...
  Vectorized(const Vectorized<tensorplay::qint8>& other) : Vectorizedqi512(other.vals) {}

  // This is added to avoid error: definition of implicit copy assignment
  // operator for 'Vectorized<tensorplay::qint8>' is deprecated because it has a
  // user-declared copy constructor [-Werror,-Wdeprecated-copy]
  Vectorized& operator=(const Vectorized<tensorplay::qint8>&) = default;
  ...
  static Vectorized<tensorplay::qint8> loadu(const void* ptr) {
    return Vectorized<tensorplay::qint8>(ptr);
  }

  static Vectorized<tensorplay::qint8> loadu(const void* ptr, int64_t count) {
    // Zero tail past `count`.
    __at_align__ value_type tmp_values[size()] = {};
    std::memcpy(
        tmp_values,
 ...
 public:
  ...
  static Vectorized<tensorplay::qint8> quantize(
      const float_vec_return_type& rhs,
      float scale,
      int32_t zero_point,
      float inverse_scale) {
    ...
    return Vectorized<tensorplay::qint8>::loadu(quantized_values);
  }

  Vectorized<tensorplay::qint8> maximum(Vectorized<tensorplay::qint8> b) const {
    return _mm512_max_epi8(vals, b.vals);
  }

  Vectorized<tensorplay::qint8> minimum(Vectorized<tensorplay::qint8> b) const {
    return _mm512_min_epi8(vals, b.vals);
  }

  Vectorized<tensorplay::qint8> relu(Vectorized<tensorplay::qint8> zero_point) const {
    return maximum(zero_point);
  }

  Vectorized<tensorplay::qint8> relu6(
      Vectorized<tensorplay::qint8> zero_point,
      Vectorized<tensorplay::qint8> q_six) {
    return _mm512_min_epi8(_mm512_max_epi8(vals, zero_point.vals), q_six.vals);
  }

  int_vec_return_type widening_subtract(Vectorized<tensorplay::qint8> b) const {
#if defined(_MSC_VER) && !defined(__clang__)
    __m128i int_val0 = _mm_set_epi64x(vals.m512i_u64[1], vals.m512i_u64[0]);
    __m128i int_val1 = _mm_set_epi64x(vals.m512i_u64[3], vals.m512i_u64[2]);
    __m128i int_val2 = _mm_set_epi64x(vals.m512i_u64[5], vals.m512i_u64[4]);
    ...
    return {
        Vectorized<tensorplay::qint32>(res_0),
        Vectorized<tensorplay::qint32>(res_1),
        Vectorized<tensorplay::qint32>(res_2),
        Vectorized<tensorplay::qint32>(res_3)};
  }

  static Vectorized<tensorplay::qint8> requantize_from_int(
      const int_vec_return_type& inp,
      float multiplier,
      int32_t zero_point) {
    __m512 multiplier_v = _mm512_set1_ps(multiplier);
...
template <>
Vectorized<tensorplay::qint8> inline maximum(
    const Vectorized<tensorplay::qint8>& a,
    const Vectorized<tensorplay::qint8>& b) {
  return a.maximum(b);
}

template <>
struct is_vec_specialized_for<tensorplay::quint8> : std::bool_constant<true> {};

template <>
struct Vectorized<tensorplay::quint8> : public Vectorizedqi512 {
  static constexpr int size() {
    return 64;
  }
  ...
  using float_vec_return_type = std::array<Vectorized<float>, 4>;
  using int_vec_return_type = std::array<Vectorized<tensorplay::qint32>, 4>;
  using value_type = tensorplay::quint8::underlying;
 ...
 public:
  ...
  // Broadcast constructor
  Vectorized(const tensorplay::quint8& val) {
    value_type uw = val.val_;
    vals = _mm512_set1_epi8(uw);
  }

  Vectorized(const Vectorized<tensorplay::quint8>& other) : Vectorizedqi512(other.vals) {}

  // This is added to avoid error: definition of implicit copy assignment
  // operator for 'Vectorized<tensorplay::quint8>' is deprecated because it has a
  // user-declared copy constructor [-Werror,-Wdeprecated-copy]
  Vectorized& operator=(const Vectorized<tensorplay::quint8>&) = default;
  ...
  static Vectorized<tensorplay::quint8> loadu(const void* ptr) {
    return Vectorized<tensorplay::quint8>(ptr);
  }

  static Vectorized<tensorplay::quint8> loadu(const void* ptr, int64_t count) {
    // Zero tail past `count`.
    __at_align__ value_type tmp_values[size()] = {};
    std::memcpy(
        tmp_values,
 ...
 public:
  ...
  static Vectorized<tensorplay::quint8> quantize(
      const float_vec_return_type& rhs,
      float scale,
      int32_t zero_point,
      float inverse_scale) {
    ...
    QuantizeAvx512<value_type>(
        rhs_data, quantized_values, 64, inverse_scale, zero_point);
    return Vectorized<tensorplay::quint8>::loadu(quantized_values);
  }

  Vectorized<tensorplay::quint8> maximum(Vectorized<tensorplay::quint8> b) const {
    return _mm512_max_epu8(vals, b.vals);
  }

  Vectorized<tensorplay::quint8> minimum(Vectorized<tensorplay::quint8> b) const {
    return _mm512_min_epu8(vals, b.vals);
  }

  Vectorized<tensorplay::quint8> relu(Vectorized<tensorplay::quint8> zero_point) const {
    return maximum(zero_point);
  }

  Vectorized<tensorplay::quint8> relu6(
      Vectorized<tensorplay::quint8> zero_point,
      Vectorized<tensorplay::quint8> q_six) {
    return _mm512_min_epu8(_mm512_max_epu8(vals, zero_point.vals), q_six.vals);
  }

  int_vec_return_type widening_subtract(Vectorized<tensorplay::quint8> b) const {
#if defined(_MSC_VER) && !defined(__clang__)
    __m128i int_val0 = _mm_set_epi64x(vals.m512i_u64[1], vals.m512i_u64[0]);
    __m128i int_val1 = _mm_set_epi64x(vals.m512i_u64[3], vals.m512i_u64[2]);
    __m128i int_val2 = _mm_set_epi64x(vals.m512i_u64[5], vals.m512i_u64[4]);
  ...
  static Vectorized<tensorplay::quint8> requantize_from_int(
      const int_vec_return_type& inp,
      float multiplier,
      int32_t zero_point) {
    __m512 multiplier_v = _mm512_set1_ps(multiplier);
...
template <>
Vectorized<tensorplay::quint8> inline maximum(
    const Vectorized<tensorplay::quint8>& a,
    const Vectorized<tensorplay::quint8>& b) {
  return a.maximum(b);
}
...
struct VectorizedQuantizedConverter {
  ...
  float_vec_return_type dequantize(
    ...
    for (const auto i : tensorplay::irange(float_num_vecs())) {
      float tmp_vals[16];
      for (const auto j : tensorplay::irange(16)) {
        tmp_vals[j] = tensorplay::dequantize_val<T>(
...
template <>
struct Vectorized<tensorplay::qint32> : public VectorizedQuantizedConverter512<
                                     tensorplay::qint32,
                                     std::array<Vectorized<float>, 1>,
                                     std::array<Vectorized<tensorplay::qint32>, 1>,
                                     16> {
  Vectorized()
      : VectorizedQuantizedConverter<
            ...
            std::array<Vectorized<tensorplay::qint32>, 1>,
            16>() {}
  Vectorized(tensorplay::qint32 val)
      : VectorizedQuantizedConverter<
            tensorplay::qint32,
            std::array<Vectorized<float>, 1>,
            std::array<Vectorized<tensorplay::qint32>, 1>,
  ...
  static Vectorized<tensorplay::qint32> quantize(
    ...
    tensorplay::quantize_vec<tensorplay::qint32, /*precision=*/32>(
        ...
        zero_point,
        float_vals.data(),
        (tensorplay::qint32*)qvals.data(),
        16 * float_num_vecs());

    return Vectorized<tensorplay::qint32>::loadu(qvals.data());
  }
...
Vectorized<tensorplay::qint32> inline operator*(
    ...
    const Vectorized<tensorplay::qint32>& b) {
  Vectorized<tensorplay::qint32> retval;
  for (const auto i : tensorplay::irange(std::decay_t<decltype(a)>::size())) {
...
template <>
struct Vectorized<tensorplay::qint8> : public VectorizedQuantizedConverter512<
                                    tensorplay::qint8,
                                    std::array<Vectorized<float>, 4>,
                                    std::array<Vectorized<tensorplay::qint32>, 4>,
                                    64> {
  Vectorized()
      : VectorizedQuantizedConverter<
            tensorplay::qint8,
            ...
            std::array<Vectorized<tensorplay::qint32>, 4>,
            64>() {}
  Vectorized(tensorplay::qint8 val)
      : VectorizedQuantizedConverter<
            tensorplay::qint8,
            std::array<Vectorized<float>, 4>,
            std::array<Vectorized<tensorplay::qint32>, 4>,
  ...
  static Vectorized<tensorplay::qint8> quantize(
    ...
    tensorplay::quantize_vec<tensorplay::qint8>(
        scale,
        zero_point,
        float_vals.data(),
        (tensorplay::qint8*)qvals.data(),
        16 * float_num_vecs());

    return Vectorized<tensorplay::qint8>::loadu(qvals.data());
  }

  Vectorized<tensorplay::qint8> maximum(Vectorized<tensorplay::qint8> b) const {
    Vectorized<tensorplay::qint8> retval;
    for (const auto i : tensorplay::irange(size())) {
      retval.vals[i] = std::max<value_type>(vals[i], b.vals[i]);
    }
    return retval;
  ...
  int_vec_return_type widening_subtract(Vectorized<tensorplay::qint8> b) const {
    ...
    for (const auto i : tensorplay::irange(int_num_vecs())) {
      for (const auto j : tensorplay::irange(elem_per_int_vec)) {
        retval[i].vals[j] =
...
template <>
struct Vectorized<tensorplay::quint8> : public VectorizedQuantizedConverter512<
                                     tensorplay::quint8,
                                     std::array<Vectorized<float>, 4>,
                                     std::array<Vectorized<tensorplay::qint32>, 4>,
                                     64> {
  Vectorized()
      : VectorizedQuantizedConverter<
            ...
            std::array<Vectorized<tensorplay::qint32>, 4>,
            64>() {}
  Vectorized(tensorplay::quint8 val)
      : VectorizedQuantizedConverter<
            tensorplay::quint8,
            std::array<Vectorized<float>, 4>,
            std::array<Vectorized<tensorplay::qint32>, 4>,
  ...
  static Vectorized<tensorplay::quint8> quantize(
    ...
    tensorplay::quantize_vec<tensorplay::quint8>(
        scale,
        zero_point,
        float_vals.data(),
        (tensorplay::quint8*)qvals.data(),
        16 * float_num_vecs());

    return Vectorized<tensorplay::quint8>::loadu(qvals.data());
  }

  Vectorized<tensorplay::quint8> maximum(Vectorized<tensorplay::quint8> b) const {
    Vectorized<tensorplay::quint8> retval;
    for (const auto i : tensorplay::irange(size())) {
      retval.vals[i] = std::max<value_type>(vals[i], b.vals[i]);
    }
    return retval;
