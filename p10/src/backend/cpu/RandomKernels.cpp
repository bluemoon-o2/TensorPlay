...
TENSORPLAY_REGISTER_KERNEL(bernoulli, CPU, bernoulli_kernel)
TENSORPLAY_REGISTER_KERNEL(normal, CPU, normal_kernel)
TENSORPLAY_REGISTER_KERNEL(poisson, CPU, poisson_kernel)

TENSORPLAY_REGISTER_KERNEL(bernoulli_, CPU, bernoulli_inplace_kernel)
TENSORPLAY_REGISTER_KERNEL(cauchy_, CPU, cauchy_kernel)
TENSORPLAY_REGISTER_KERNEL(exponential_, CPU, exponential_kernel)
TENSORPLAY_REGISTER_KERNEL(geometric_, CPU, geometric_kernel)
TENSORPLAY_REGISTER_KERNEL(log_normal_, CPU, log_normal_kernel)
TENSORPLAY_REGISTER_KERNEL(normal_, CPU, normal_inplace_kernel)
TENSORPLAY_REGISTER_KERNEL(random_, CPU, random_kernel)
TENSORPLAY_REGISTER_KERNEL(uniform_, CPU, uniform_kernel)
