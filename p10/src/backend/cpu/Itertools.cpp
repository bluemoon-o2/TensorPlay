...
Tensor cartesian_prod_native_cpu(const std::vector<Tensor>& tensors) {
...
TENSORPLAY_LIBRARY_IMPL(CPU, NativeItertools) {
    m.impl("cartesian_prod", cartesian_prod_native_cpu);
}
