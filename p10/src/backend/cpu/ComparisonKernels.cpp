...
TENSORPLAY_REGISTER_KERNEL_STR("eq.Tensor", CPU, eq_tensor_kernel)
TENSORPLAY_REGISTER_KERNEL_STR("eq.Scalar", CPU, eq_scalar_kernel)
TENSORPLAY_REGISTER_KERNEL_STR("ne.Tensor", CPU, ne_tensor_kernel)
TENSORPLAY_REGISTER_KERNEL_STR("ne.Scalar", CPU, ne_scalar_kernel)
TENSORPLAY_REGISTER_KERNEL_STR("lt.Tensor", CPU, lt_tensor_kernel)
TENSORPLAY_REGISTER_KERNEL_STR("lt.Scalar", CPU, lt_scalar_kernel)
TENSORPLAY_REGISTER_KERNEL_STR("le.Tensor", CPU, le_tensor_kernel)
TENSORPLAY_REGISTER_KERNEL_STR("le.Scalar", CPU, le_scalar_kernel)
TENSORPLAY_REGISTER_KERNEL_STR("gt.Tensor", CPU, gt_tensor_kernel)
TENSORPLAY_REGISTER_KERNEL_STR("gt.Scalar", CPU, gt_scalar_kernel)
TENSORPLAY_REGISTER_KERNEL_STR("ge.Tensor", CPU, ge_tensor_kernel)
