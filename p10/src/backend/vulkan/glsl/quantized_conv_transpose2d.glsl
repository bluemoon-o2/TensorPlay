...
/*
 * TILE_SIZE = (1, 1, 1)
 * WEIGHT_STORAGE = TEXTURE_3D (the rearranged transposed-conv weight keeps
 * its interleaved structure; the packed planes ride the texture as an image
 * with the output-channel groups of four in the texel lanes)
