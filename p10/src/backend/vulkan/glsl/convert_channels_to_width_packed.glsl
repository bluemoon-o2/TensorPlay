...
layout(set = 0, binding = 2) uniform PRECISION restrict Block {
  ivec4 sizes; // (N, C, H, W) logical sizes of the input
}
uBlock;
...
void main() {
  ...
  // The channel count is the second NCHW component, while the output depth
  // enumerates every batch/channel pair without lane packing.
