...
void Context::register_shader_dispatch(
  ...
  const utils::uvec3 effective_global_wg = {
      utils::div_up(
          global_workgroup_size[0u],
          shader_descriptor.out_tile_size[0u]),
      utils::div_up(
          global_workgroup_size[1u],
          shader_descriptor.out_tile_size[1u]),
      utils::div_up(
          global_workgroup_size[2u],
          shader_descriptor.out_tile_size[2u]),
  };
