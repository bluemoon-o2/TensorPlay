...
class detect_anomaly:
    ...
    def __init__(self, check_nan=True) -> None:
        self.prev = _autograd.is_anomaly_enabled()
        self.check_nan = check_nan
        self.prev_check_nan = _autograd.is_anomaly_check_nan_enabled()
        warnings.warn(
    ...
    def __enter__(self) -> None:
        _autograd.set_anomaly_enabled(True, self.check_nan)

    def __exit__(self, *args: object) -> None:
        _autograd.set_anomaly_enabled(self.prev, self.prev_check_nan)
...
class set_detect_anomaly:
    ...
    def __init__(self, mode: bool, check_nan: bool = True) -> None:
        self.prev = _autograd.is_anomaly_enabled()
        self.prev_check_nan = _autograd.is_anomaly_check_nan_enabled()
        _autograd.set_anomaly_enabled(mode, check_nan)
