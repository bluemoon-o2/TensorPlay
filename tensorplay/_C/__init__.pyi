...
class TensorBase:
    ...
    def narrow(self, dim: int, start: int, length: int) -> TensorBase: ...
    ...
    @overload
    @overload
    def max(self, dim: int, keepdim: bool = False) -> tuple[TensorBase, TensorBase]: ...
    ...
    @overload
    @overload
    def min(self, dim: int, keepdim: bool = False) -> tuple[TensorBase, TensorBase]: ...
...
@overload
def max(self: TensorBase, dim: int, keepdim: bool = False) -> tuple[TensorBase, TensorBase]: ...

@overload
def min(self: TensorBase) -> TensorBase: ...

@overload
def min(self: TensorBase, dim: int, keepdim: bool = False) -> tuple[TensorBase, TensorBase]: ...
