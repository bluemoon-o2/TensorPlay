...
def grad(outputs: Sequence[tensorplay._C.TensorBase], inputs: Sequence[tensorplay._C.TensorBase], grad_outputs: Sequence[tensorplay._C.TensorBase | None] | None = None, retain_graph: bool | None = None, create_graph: bool = False, allow_unused: bool = False) -> list[tensorplay._C.TensorBase | None]: ...
