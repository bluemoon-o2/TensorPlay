...
from ...node import _get_qualified_name, Node
from ..operator_support import OperatorSupportBase
from ..utils.fuser_utils import fuse_by_partitions
...
class CapabilityBasedPartitioner:
    ...
    def propose_partitions(self) -> list[Partition]:
        ...
        if not self.allows_single_node_partition:
            ...
            default_non_compute_ops = {"view", "operator.getitem", "_operator.getitem"}
