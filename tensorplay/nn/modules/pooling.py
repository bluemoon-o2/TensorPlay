...
from tensorplay.nn.common_types import (
    _ratio_2_t,
    _ratio_3_t,
    _size_1_t,
    _size_2_opt_t,
...
from .utils import _pair, _single, _triple  # noqa
...
class MaxPool1d(_MaxPoolNd):
    ...
    Args:
        ...
        return_indices: If ``True``, will return the argmax along with the max values.
                        Useful for :class:`tensorplay.nn.MaxUnpool1d` later
...
class MaxPool2d(_MaxPoolNd):
    ...
    Args:
        ...
        return_indices: if ``True``, will return the max indices along with the outputs.
                        Useful for :class:`tensorplay.nn.MaxUnpool2d` later
...
class MaxPool3d(_MaxPoolNd):
    ...
    Args:
        ...
        dilation: a parameter that controls the stride of elements in the window
        return_indices: if ``True``, will return the max indices along with the outputs.
                        Useful for :class:`tensorplay.nn.MaxUnpool3d` later
        ceil_mode: when True, will use `ceil` instead of `floor` to compute the output shape
...
class MaxUnpool1d(_MaxUnpoolNd):
    ...
    Inputs:
        ...
        - `indices`: the indices given out by :class:`~tensorplay.nn.MaxPool1d`
...
class MaxUnpool2d(_MaxUnpoolNd):
    ...
    Inputs:
        - `input`: the input Tensor to invert
        - `indices`: the indices given out by :class:`~tensorplay.nn.MaxPool2d`
        - `output_size` (optional): the targeted output size
...
class MaxUnpool3d(_MaxUnpoolNd):
    ...
    Inputs:
        - `input`: the input Tensor to invert
        - `indices`: the indices given out by :class:`~tensorplay.nn.MaxPool3d`
        - `output_size` (optional): the targeted output size
