...
from .batchnorm import _LazyNormBase, _NormBase  # noqa
...
class InstanceNorm1d(_InstanceNorm):
    ...
    Examples::
        ...
        >>> input = tensorplay.randn(20, 100, 40)
        >>> output = m(input)
    """
...
class LazyInstanceNorm1d(_LazyNormBase, _InstanceNorm):
    r"""A :class:`tensorplay.nn.InstanceNorm1d` module with lazy initialization of the ``num_features`` argument.
...
class LazyInstanceNorm2d(_LazyNormBase, _InstanceNorm):
    r"""A :class:`tensorplay.nn.InstanceNorm2d` module with lazy initialization of the ``num_features`` argument.
...
class LazyInstanceNorm3d(_LazyNormBase, _InstanceNorm):
    r"""A :class:`tensorplay.nn.InstanceNorm3d` module with lazy initialization of the ``num_features`` argument.
