...
It has no tensorplay dependencies to avoid circular imports during initialization.
"""
    ...
    *,
    ...
    Args:
        ...
        register_fn: Callable that performs the actual dispatcher registration.
            ...
            and should register custom kernels with the dispatcher.
...
def activate_flash_attention_impl(
    ...
    Args:
        impl: Implementation identifier to activate. See
            :func:`~tensorplay.nn.attention.list_flash_attention_impls` for available
            implementations.
