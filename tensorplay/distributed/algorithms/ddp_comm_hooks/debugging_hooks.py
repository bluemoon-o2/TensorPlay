...
from tensorplay.distributed import GradBucket
...
def noop_hook(_: Any, bucket: GradBucket):
    """
    ...
    if GPU traces cannot be easily retrieved or the trace analysis is complicated by
