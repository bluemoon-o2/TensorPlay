...
static void tp_body(void* ctxp, long long b, long long e) {
    ...
    for (; i + 4 * W <= e; i += 4 * W) {
        ...
        V t00 = (x00 + x10);
        V t10 = (V(1.0f) / (V(1.0f) + (-t00).exp()));
        V t01 = (x01 + x11);
        V t11 = (V(1.0f) / (V(1.0f) + (-t01).exp()));
        V t02 = (x02 + x12);
        V t12 = (V(1.0f) / (V(1.0f) + (-t02).exp()));
        V t03 = (x03 + x13);
        V t13 = (V(1.0f) / (V(1.0f) + (-t03).exp()));
        t10.store(out + i, W);
...
extern "C" void tp_native_1774e3751c52dfed(long n, const float* __restrict__ in0, const float* __restrict__ in1, float* __restrict__ out) {
